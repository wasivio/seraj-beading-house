...
import { SlidersHorizontal, ArrowUpDown, X, AlertCircle } from 'lucide-react';
...
export const Categories: React.FC = () => {
  ...
  }, [products, urlSearch, selectedCategory, selectedBrand, urlFilter, maxPrice, minRating, inStockOnly, minDiscount, sortBy]);
  ...
  // Extract unique brands present in the product database
